...
- (void)viewDidLoad {
    ...
    // [self.signUpView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@""]]];
    
    // use above text if you want a specific back ground but is not use whiteColor because above @"" is transparent when sign up move up over logIn and you can see through it.
    [self.signUpView setBackgroundColor:[UIColor whiteColor]];

    [self.signUpView setLogo:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Logo_Lokay@2x"]]];
    ...
    [self.signUpView.signUpButton setBackgroundImage:[UIImage imageNamed:@"Signup_up@2x.png"] forState:UIControlStateNormal];
    [self.signUpView.signUpButton setBackgroundImage:[UIImage imageNamed:@"Signup_down@2x.png"] forState:UIControlStateHighlighted];
    ...
    [self setFieldsBackground:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SignupBG@2x.png"]]];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.signUpView.dismissButton setFrame:CGRectMake(5.0f, 10.0f, 27.5f, 45.5f)];
